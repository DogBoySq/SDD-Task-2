...
# Opening and displaying the cat
main_image = Image.open("lokisolos.png")
resized_image = main_image.resize((128, 128))
main_photo = ImageTk.PhotoImage(resized_image)
main_image_label = tk.Label(main_page_frame, image=main_photo)
main_image_label.photo = main_photo
...
# Opening and displaying the cat
binary_search_image = Image.open("pamonha20.png")
binary_search_photo = ImageTk.PhotoImage(binary_search_image)
binary_search_image_label = tk.Label(binary_search_page_frame, image=binary_search_photo, bg="white")
binary_search_image_label.photo = binary_search_photo
binary_search_image_label.pack(pady=5)
...
# Opening and displaying the cat
bubble_sort_image = Image.open("grahhh.png")
bubble_sort_photo = ImageTk.PhotoImage(bubble_sort_image)
bubble_sort_image_label = tk.Label(bubble_sort_page_frame, image=bubble_sort_photo, bg="white")
bubble_sort_image_label.photo = bubble_sort_photo
bubble_sort_image_label.pack(pady=5)
